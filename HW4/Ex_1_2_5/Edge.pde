static final color easycolor = #D3D3D3;
...
void draw(boolean activeStatus) {
   if(activeStatus) {
    ...
    if (col == "r") stroke(easycolor);
    else if(col == "o") stroke(easycolor);
    else if(col == "g") stroke(easycolor);
    else if(col == "b") stroke(easycolor);
   }
    strokeWeight(2);
